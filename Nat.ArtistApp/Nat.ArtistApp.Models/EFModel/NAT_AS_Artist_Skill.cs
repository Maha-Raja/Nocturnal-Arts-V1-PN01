...
namespace Nat.ArtistApp.Models.EFModel
{
    ...
    public partial class NAT_AS_Artist_Skill : Entity
    {
        public int Artist_Skill_ID { get; set; }
        public Nullable<int> Artist_ID { get; set; }
        public Nullable<int> Skill_LKP_ID { get; set; }
        public Nullable<int> Skill_Rating { get; set; }
