...
{
    public class ArtistRequestViewModel: BaseAutoViewModel<ArtistRequestModel, ArtistRequestViewModel>
    {
        ...
        [Complex]
        public ICollection<ArtistDocumentRequestViewModel> Document { get; set; }

        [Complex]
        public ICollection<ArtistSkillRequestViewModel> Skill { get; set; }
        [Complex]
        public ICollection<ArtistAvailabilityRequestViewModel> Availability { get; set; }
