...
namespace Nat.PaintingApp.Services
{
        ...
        where UEntity : class, IObjectState, new()
    {
        ...
        public PaintingEntities entityContext;
	...
	private NatLogger _logger;
        ...
        public BaseService()
        {
            // entityContext = PaintingEntities.CreateContext(true); //TODO Read this flag from configuration
            entityContext = PaintingEntities.CreateContext(false);
