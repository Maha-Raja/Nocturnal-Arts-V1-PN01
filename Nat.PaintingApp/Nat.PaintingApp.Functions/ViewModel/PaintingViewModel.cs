...
namespace Nat.PaintingApp.Functions.ViewModels
{
	public class PaintingViewModel : BaseAutoViewModel<PaintingModel, PaintingViewModel>
	{
		...
		public ICollection<PaintingRatingLogViewModel> NatPsPaintingRatingLog { get; set; }
		public ICollection<PaintingRatingViewModel> NatPsPaintingRating { get; set; }
        [Complex]
        public ICollection<PaintingEventViewModel> NatPsPaintingEvent { get; set; }
        [Complex]
