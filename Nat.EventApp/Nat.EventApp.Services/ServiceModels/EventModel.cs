...
namespace Nat.EventApp.Services.ServiceModels
{
	public class EventModel : BaseServiceModel<NAT_ES_Event, EventModel>, IObjectState
	{
        ...
        public Nullable<DateTime> OldEventDate { get; set; }
        public Nullable<DateTime> OldEventStartTime { get; set; }
        public Nullable<DateTime> OldEventEndTime { get; set; }
        ...
        [Complex]
        public ICollection<EventTicketPriceModel> NatEsEventTicketPrice { get; set; }
        [Complex]
        ...
        public string EventCancellationURL { get; set; }
