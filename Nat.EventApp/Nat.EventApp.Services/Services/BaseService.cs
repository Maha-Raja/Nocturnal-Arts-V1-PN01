...
namespace Nat.EventApp.Services
{
        ...
        where UEntity : class, IObjectState, new()
    {
        ...
        public EventEntities entityContext;
	...
	private NatLogger _logger;
        ...
        public BaseService()
        {
            // entityContext = EventEntities.CreateContext(true); //TODO Read this flag from configuration
            entityContext = EventEntities.CreateContext(false);
