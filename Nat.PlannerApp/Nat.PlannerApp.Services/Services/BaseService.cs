...
namespace Nat.PlannerApp.Services
{
        ...
        where UEntity : class, IObjectState, new()
    {
        ...
        public PlannerEntities entityContext;
	...
	private NatLogger _logger;
        ...
        public BaseService()
        {
            // entityContext = PlannerEntities.CreateContext(true); //TODO Read this flag from configuration
            entityContext = PlannerEntities.CreateContext(false);
