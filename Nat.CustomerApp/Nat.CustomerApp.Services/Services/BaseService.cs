...
namespace Nat.CustomerApp.Services
{
        ...
        where UEntity : class, IObjectState, new()
    {
        ...
        public CustomerEntities entityContext;
	...
	private NatLogger _logger;
        ...
        public BaseService()
        {
            // entityContext = CustomerEntities.CreateContext(true); //TODO Read this flag from configuration
            entityContext = CustomerEntities.CreateContext(false);
