...
namespace Nat.Core.Caching
{
    public static class Caching
    {
        /// <summary>
        /// A generic async method for getting and setting objects to the memory cache.
        /// </summary>
        ...
        /// <param name="objectSettingFunction">A parameterless async function to call if the object isn't in the cache and you need to set it.</param>
        /// <returns>An object of the type you asked for</returns>
        public static async Task<T> GetObjectFromCacheAsync<T>(string cacheItemName, int cacheTimeInMinutes, Func<Task<T>> objectSettingFunction)
        {
        ...
        public static void ClearCache(string cacheItemName)
        {
            ObjectCache cache = MemoryCache.Default;
